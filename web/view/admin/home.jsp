    ...
    <body>
        ...
        <jsp:include page="header.jsp"></jsp:include>
            <div class="container" style="height: 600px">
                ...
                <li class="list-group-item px-3 border-0"><a href="admin/view">Quản lí kế hoạch ở xưởng</a></li>
<!--                <li class="list-group-item px-3 border-0"><a href="emp/view">Chi phí kế hoạch</a></li>-->
